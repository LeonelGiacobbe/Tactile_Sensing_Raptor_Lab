    ...
    with utilities.DeviceConnection.createTcpConnection(args1) as router1, utilities.DeviceConnection.createTcpConnection(args2) as router2:
        ...
        try:
            ...
            for i in range(4):
                ...
                P_SLIP_1 = 32.0 + rand_slip # Must be a value in mm (not percentage of gripper opening)
                P_SLIP_2 = 32.0 + rand_slip # Must be a value in mm (not percentage of gripper opening)

                rand_goto = random.uniform(0.0,0.005)
                gripper1.Goto(0.65 + rand_goto)
                gripper2.Goto(0.79 + rand_goto)

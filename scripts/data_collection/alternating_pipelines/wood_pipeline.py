    ...
    with utilities.DeviceConnection.createTcpConnection(args1) as router1, utilities.DeviceConnection.createTcpConnection(args2) as router2:
        ...
        try:
            ...
            for i in range(3):
                ...
                P_SLIP_1 = 24.45 + rand_slip # Must be a value in mm (not percentage of gripper opening)
                P_SLIP_2 = 24.45 + rand_slip # Must be a value in mm (not percentage of gripper opening)

                rand_goto = random.uniform(0.0,0.005)
                gripper1.Goto(0.743 + rand_goto)
                gripper2.Goto(0.853 + rand_goto)

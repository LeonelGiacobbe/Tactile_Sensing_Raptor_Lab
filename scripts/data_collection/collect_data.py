...
def reset_arms(base1, base_cyclic1, base2, base_cyclic2):
    ...
    start_pos(base1, base_cyclic1)
    start_pos(base2, base_cyclic2)
...
def main():
    ...
    router1 = utilities.DeviceConnection.createTcpConnection(ip="some_ip")
    router2 = utilities.DeviceConnection.createTcpConnection(ip="some_other_ip")

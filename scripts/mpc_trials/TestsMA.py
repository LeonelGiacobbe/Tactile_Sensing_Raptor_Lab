...
class MultiAgentMpc():
    ...
    def _get_gelsight_images(self):
        ...
        """
        cv_image_1 = cv2.imread(os.getcwd() + "testing_images/sensor_1_empty.jpg")
        cv_image_2 = cv2.imread(os.getcwd() + "testing_images/sensor_2_empty.jpg")

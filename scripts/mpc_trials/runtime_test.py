...
# Load images
# ~25.4
image_path_1 = "testing_images/sensor_1_empty.jpg"
image_path_2 = "testing_images/sensor_2_empty.jpg"
...
# Dummy gripper state
posi_1 = torch.tensor([23.013]).to(device)
vel_1 = torch.tensor([2.6]).to(device)
posi_2 = torch.tensor([23.33]).to(device)

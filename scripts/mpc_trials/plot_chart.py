...
with open('./results/multiagent/coffee_beans_40mm_multiagent_position_log.csv', 'r') as f:
    reader = csv.reader(f)
    for row in reader:
...
plt.savefig("new_coffee_40mm_multiagent_position_plot.pdf", bbox_inches="tight")

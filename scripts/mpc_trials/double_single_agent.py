...
class MultiAgentMpc():
    ...
    def __init__(self, gripper_1, gripper_2):
        ...
        # Load weights
        model_path = os.path.join(os.getcwd(), 'single_letac_mpc_model.pth')
    ...
    def _run_inference(self, image_1, image_2, posi_1, vel_1, posi_2, vel_2):
        ...
        with self.stream, torch.no_grad():
            ...
            pos_sequences_2 = self.mpc_layer(output_2, posi_2, vel_2)
            #end = time.time()
    ...
    def _run_model(self):
        ...
        try:
            while True:
                ...
                # Kinova always outputs positive velocity but the mpc layer expects signed
